...
/**
 * The persistent class for the V_DETAILS_ODF_CA_INV database table.
 * 
 */
@Entity
@Table(name="V_DETAILS_ODF_CA_INV")
@NamedQuery(name="VDetailsOdfCaInv.findAll", query="SELECT v FROM VDetailsOdfCaInv v")
public class VDetailsOdfCaInv implements Serializable {
