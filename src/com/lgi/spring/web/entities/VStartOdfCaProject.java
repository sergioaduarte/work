...
/**
 * The persistent class for the V_START_ODF_CA_PROJECT database table.
 * 
 */
@Entity
@Table(name="V_START_ODF_CA_PROJECT")
@NamedQuery(name="VStartOdfCaProject.findAll", query="SELECT v FROM VStartOdfCaProject v")
public class VStartOdfCaProject implements Serializable {
