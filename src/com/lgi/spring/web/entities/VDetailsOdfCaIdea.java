...
/**
 * The persistent class for the V_DETAILS_ODF_CA_IDEA database table.
 * 
 */
@Entity
@Table(name="V_DETAILS_ODF_CA_IDEA")
@NamedQuery(name="VDetailsOdfCaIdea.findAll", query="SELECT v FROM VDetailsOdfCaIdea v")
public class VDetailsOdfCaIdea implements Serializable {
