...
/**
 * The persistent class for the V_START_ODF_CA_INV database table.
 * 
 */
@Entity
@Table(name="V_START_ODF_CA_INV")
@NamedQuery(name="VStartOdfCaInv.findAll", query="SELECT v FROM VStartOdfCaInv v")
public class VStartOdfCaInv implements Serializable {
