...
/**
 * The persistent class for the V_LAYOUT_OBJECT_CHANGE database table.
 * 
 */
@Entity
@Table(name="V_LAYOUT_OBJECT_CHANGE")
@NamedQuery(name="VLayoutObjectChange.findAll", query="SELECT v FROM VLayoutObjectChange v")
public class VLayoutObjectChange implements Serializable {
