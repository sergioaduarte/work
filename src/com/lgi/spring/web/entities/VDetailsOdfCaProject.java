...
/**
 * The persistent class for the V_DETAILS_ODF_CA_PROJECT database table.
 * 
 */
@Entity
@Table(name="V_DETAILS_ODF_CA_PROJECT")
@NamedQuery(name="VDetailsOdfCaProject.findAll", query="SELECT v FROM VDetailsOdfCaProject v")
public class VDetailsOdfCaProject implements Serializable {
