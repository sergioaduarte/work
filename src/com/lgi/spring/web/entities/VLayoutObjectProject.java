...
/**
 * The persistent class for the V_LAYOUT_OBJECT_PROJECT database table.
 * 
 */
@Entity
@Table(name="V_LAYOUT_OBJECT_PROJECT")
@NamedQuery(name="VLayoutObjectProject.findAll", query="SELECT v FROM VLayoutObjectProject v")
public class VLayoutObjectProject implements Serializable {
